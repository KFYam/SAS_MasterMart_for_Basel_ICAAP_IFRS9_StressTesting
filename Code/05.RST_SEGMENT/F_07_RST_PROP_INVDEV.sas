data MART.RST_02_HK_PRTY_INVnDEV_&st_Rptmth.;
	set STG.RST_02_HK_PRTY_INVnDEV_&st_Rptmth.;
	...
	array a_npldta{4}		_temporary_ (&piv_npl0. 	&piv_npl1. 		&piv_npl2.		&piv_npl3.);
	array a_nplcov{4}		_temporary_ (&piv_nplcov0. 	&piv_nplcov1. 	&piv_nplcov2.	&piv_nplcov3.);
	array a_lgd{4}			_temporary_ (&piv_lgd0. 	&piv_lgd1. 		&piv_lgd2.		&piv_lgd3.);
	array a_lngwth{4}		_temporary_ (&piv_lgth0. 	&piv_lgth1. 	&piv_lgth2. 	&piv_lgth3.);
