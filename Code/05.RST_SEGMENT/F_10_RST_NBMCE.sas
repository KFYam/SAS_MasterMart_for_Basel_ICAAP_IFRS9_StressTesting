data MART.RST_05_NBMCE_&st_Rptmth.;
	set STG.RST_05_NBMCE_&st_Rptmth.;
	...
	array a_npldta{4}		_temporary_ (&nbmce_npl0. 		&nbmce_npl1. 		&nbmce_npl2.		&nbmce_npl3.);
	array a_nplcov{4}		_temporary_ (&nbmce_nplcov0. 	&nbmce_nplcov1. 	&nbmce_nplcov2.		&nbmce_nplcov3.);
	array a_lgd{4}			_temporary_ (&nbmce_lgd0. 		&nbmce_lgd1. 		&nbmce_lgd2.		&nbmce_lgd3.);
	array a_lngwth{4}		_temporary_ (&nbmce_lgth0. 		&nbmce_lgth1. 		&nbmce_lgth2. 		&nbmce_lgth3.);
